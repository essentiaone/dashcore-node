...
var dashcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = dashcorenode.version;
  var create = dashcorenode.scaffold.create;
  var add = dashcorenode.scaffold.add;
  var start = dashcorenode.scaffold.start;
  var remove = dashcorenode.scaffold.remove;
  var callMethod = dashcorenode.scaffold.callMethod;
  var findConfig = dashcorenode.scaffold.findConfig;
  var defaultConfig = dashcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --daemon', 'Make essx-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `essx-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ essx-node add wallet-service');
      console.log('    $ essx-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ essx-node remove wallet-service');
      console.log('    $ essx-node remove insight-api');
      console.log();
    });
