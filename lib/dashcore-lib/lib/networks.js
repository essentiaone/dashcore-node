...
addNetwork({
  ...
  privatekey: 0xd4,
  scripthash: 0x0d,
  xpubkey: 0x022d2533,    // 'xpub' (Bitcoin Default)
  xprivkey: 0x0221312b,   // 'xprv' (Bitcoin Default)
  networkMagic: 0xdfa08d8f,
  port: 9999,
  dnsSeeds: [
    'dnsseed.darkcoin.io',
    'dnsseed.dashdot.io',
...
addNetwork({
  ...
  privatekey: 0xef,
  scripthash: 0x13,
  xpubkey: 0x3a8061a0,     // 'tpub' (Bitcoin Default)
  xprivkey: 0x3a805837    // 'tprv' (Bitcoin Default)
});
